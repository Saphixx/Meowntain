...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMainContent" runat="server">
        ...
        <div class="w3-row-padding w3-padding-64 w3-container">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MeowntainConnectionString3 %>" SelectCommand="SELECT [Date_Arrived], [Picture_Path], [Description], [CatID] FROM [Cat]"></asp:SqlDataSource>
        </div>
